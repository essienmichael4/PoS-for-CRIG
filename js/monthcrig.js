let monthcrig = document.querySelector(".monthcrig");

monthcrig.addEventListener("click", ()=>{
    ...
    let itemstitle = document.querySelector(".itemstitle");
        ...
        xhr.open("GET", "../includes/crig/month/monthTableCRIG.php",true)
        xhr.onload = ()=>{
        ...
        salexhr.open("GET", "../includes/crig/month/monthSalesCRIG.php",true)
        salexhr.onload = ()=>{
        ...
        orderxhr.open("GET", "../includes/crig/month/monthOrdersCRIG.php",true)
        orderxhr.onload = ()=>{
        ...
        itemxhr.open("GET", "../includes/crig/month/monthItemsCRIG.php",true)
        itemxhr.onload = ()=>{
