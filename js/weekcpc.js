let weekcpc = document.querySelector(".weekcpc");

weekcpc.addEventListener("click", ()=>{
    ...
    let itemstitle = document.querySelector(".itemstitle");
        ...
        xhr.open("GET", "../includes/cpc/week/weekTableCPC.php",true)
        xhr.onload = ()=>{
        ...
        salexhr.open("GET", "../includes/cpc/week/weekSalesCPC.php",true)
        salexhr.onload = ()=>{
        ...
        orderxhr.open("GET", "../includes/cpc/week/weekOrdersCPC.php",true)
        orderxhr.onload = ()=>{
        ...
        itemxhr.open("GET", "../includes/cpc/week/weekItemsCPC.php",true)
        itemxhr.onload = ()=>{
