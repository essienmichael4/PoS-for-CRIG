let yearcrig = document.querySelector(".yearcrig");

yearcrig.addEventListener("click", ()=>{
    ...
    let itemstitle = document.querySelector(".itemstitle");
        ...
        xhr.open("GET", "../includes/crig/year/yearTableCRIG.php",true)
        xhr.onload = ()=>{
        ...
        salexhr.open("GET", "../includes/crig/year/yearSalesCRIG.php",true)
        salexhr.onload = ()=>{
        ...
        orderxhr.open("GET", "../includes/crig/year/yearOrdersCRIG.php",true)
        orderxhr.onload = ()=>{
        ...
        itemxhr.open("GET", "../includes/crig/year/yearItemsCRIG.php",true)
        itemxhr.onload = ()=>{
