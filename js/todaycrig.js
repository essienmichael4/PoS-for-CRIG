...
todaycrig.addEventListener("click", ()=>{
    ...
    let item = document.querySelector(".item");
        ...
        xhr.open("GET", "../includes/crig/today/todayTableCPC.php", true);
        xhr.onload = ()=>{
        ...
        salexhr.open("GET", "../includes/crig/today/todaysSalesCPC.php", true);
        salexhr.onload = ()=>{
        ...
        orderxhr.open("GET", "../includes/crig/today/todaysOrdersCPC.php", true);
        orderxhr.onload = ()=>{
        ...
        itemxhr.open("GET", "../includes/crig/today/todaysItemsCPC.php", true);
        itemxhr.onload = ()=>{
